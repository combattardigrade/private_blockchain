# Description
Test application that allows users to to register stars and save them into a blockchain. The application implements blockchain identity and proof of existance to track the amount of stars each address owns.
